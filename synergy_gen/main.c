...
extern void LED_thread1_create(void);
extern void LED_thread2_create(void);
extern void LED_thread3_create(void);
extern void LED_thread4_create(void);
extern void LED_thread5_create(void);
extern void LED_thread6_create(void);
extern void LED_thread7_create(void);
extern void LED_thread8_create(void);
extern void LED_thread9_create(void);
extern void LED_thread10_create(void);
extern void SerialOutput_thread_create(void);
extern void buttom_thread_create(void);
extern void irq_thread_create(void);
extern void watch_dog_thread_create(void);
...
void tx_application_define(void *first_unused_memory)
{
    ...
    LED_thread9_create ();
    LED_thread10_create ();
    SerialOutput_thread_create ();
    buttom_thread_create ();
    irq_thread_create ();
    watch_dog_thread_create ();
